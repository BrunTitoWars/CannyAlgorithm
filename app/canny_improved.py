...
cv2.imwrite('../output/canny_improved/original_image.png', img)
cv2.imwrite('../output/canny_improved/gaussian_blur.png', np.uint8(gaussian_blur))
cv2.imwrite('../output/canny_improved/gradient_magnitude.png', np.uint8(gradient_magnitude / gradient_magnitude.max() * 255))
cv2.imwrite('../output/canny_improved/nms.png', np.uint8(nms / nms.max() * 255))
cv2.imwrite('../output/canny_improved/thresholded.png', np.uint8(thresholded))
cv2.imwrite('../output/canny_improved/edges.png', edges_uint8)
cv2.imwrite('../output/canny_improved/noisy_image.png', noisy_img)
